...
For those you have experienced only group theory, replace the word *ring* by :math:`\mathbb{Z}` the interger ring which is also an abelian group under addition.
